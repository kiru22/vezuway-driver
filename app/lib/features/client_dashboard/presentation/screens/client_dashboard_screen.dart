...
import '../../domain/providers/client_dashboard_provider.dart';
import '../widgets/client_stats_grid.dart';
import '../widgets/my_packages_list.dart';
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              // Stats section
              SliverToBoxAdapter(
                child: clientStats.when(
                  data: (stats) => Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    child: ClientStatsGrid(stats: stats),
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Admin option (solo para super_admin)
          if (isSuperAdmin) ...[
            const SizedBox(height: 6),
            _MenuOption(
